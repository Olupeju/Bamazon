...
var run = function() {
    //  the database query that shows  all products available for purchase
    connection.query("SELECT * FROM products", function(err, results) {
        if (err) throw err;
        ...
        inquirer.prompt([
            ...
            if (chosenProduct.stock_quantity >(answer.amount)) {
                ...
                },
                {
                    ...
                    console.log("Item Count: " + answer.amount);
                    console.log("-----------------------------");
                    console.log("Total: " + "$" + (chosenProduct.price * answer.amount));
                    console.log("==============================================");
                    console.log("\n\n");
                    display();
                    run();
